...
//    private var endDate: Date? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sliderYear.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvYear.text = rangeSlider.values[0].toInt().toString()
            binding.hvYear.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderLength.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvLength.text = rangeSlider.values[0].toInt().toString()
            binding.hvLength.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderMaxPassengers.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvPassengers.text = rangeSlider.values[0].toInt().toString()
            binding.hvPassengers.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderBeds.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvBeds.text = rangeSlider.values[0].toInt().toString()
            binding.hvBeds.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderCabins.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvCabins.text = rangeSlider.values[0].toInt().toString()
            binding.hvCabins.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderBathroom.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvBath.text = rangeSlider.values[0].toInt().toString()
            binding.hvBath.text = rangeSlider.values[1].toInt().toString()
        ...
        binding.sliderPrice.addOnChangeListener { rangeSlider, value, fromUser ->
            binding.lvPrice.text = rangeSlider.values[0].toInt().toString()
            binding.hvPrice.text = rangeSlider.values[1].toInt().toString()
